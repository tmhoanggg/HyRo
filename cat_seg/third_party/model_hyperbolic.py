...
class CLIP(nn.Module):
    def __init__(self,
        ...
        set_adapter_hyperbolic(self.transformer, dim=128, dim_rot=256, hidden_size=transformer_width)
        set_adapter_vision_hyperbolic(self.visual, dim=128, dim_rot=256, hidden_size=vision_width)
